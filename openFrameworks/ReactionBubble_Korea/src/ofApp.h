...
#define KINECT_FAR_THRESHOLD 201

// check this against arduino app
#define ARDUINO_SERIAL_CAP "/dev/tty.usbmodem14131"
#define ARDUINO_SERIAL_BB "/dev/tty.usbmodem141411"

// total number of sensors/headers
// 14 for no glitch, 15 for glitch - IMPORTANT!
#define NUM_SENSORS 15
// boolean for using glitch
#define GLITCH_ON true

// switches between BEAM BREAKS and WEARABLE controllers
#define WEARABLES true

#define ARDUINO_ON false
#define ARDUINO_CAP_ON false
